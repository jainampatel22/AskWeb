    ...
    <div>
      ...
      <main className="bg-gradient-to-b from-white to-gray-50/50 pt-16 sm:pt-28">
        ...
        <section className="w-full px-4 py-6 sm:py-8 mx-auto max-w-7xl sm:px-6 lg:px-8 flex flex-col items-center space-y-6 sm:space-y-10 text-center">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 bg-clip-text text-transparent">
              Chat With{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-600">
                Website&apos;s
              </span>
            </h1>
            <h6 className="max-w-[600px] text-sm sm:text-base md:text-xl/relaxed xl:text-xl/relaxed pt-8 sm:pt-0 text-gray-600 px-2">
